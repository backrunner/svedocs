---
name: use-svedocs
description: Build, extend, and maintain svedocs documentation sites. Use when creating a svedocs project, adding Markdown/MDX/SVX content, wiring svedocs into SvelteKit, changing docs routes, using the svedocs CLI, enabling search or Ask AI, upgrading svedocs, or diagnosing a svedocs site.
---
...
- Change behavior: use public imports such as `svedocs/config`, `svedocs/core`, `svedocs/routes`, `svedocs/theme`, `svedocs/search`, `svedocs/ai`, `svedocs/og`, and `svedocs/cloudflare`.
